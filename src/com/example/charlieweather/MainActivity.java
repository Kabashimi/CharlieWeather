	    ...
	    switch (item.getItemId()) {
	    					...
	    					public void onClick(DialogInterface dialog,int id) {
	    						if(input.getText().toString().length()>2){
	    							...
	    							if(IsNetworkAvailable.isNetworkAvailable())
	    				        		...
	    				        		Toast.makeText(Helper.context,getResources().getText(R.string.Internet_Is_Disabled),Toast.LENGTH_LONG).show();
	        ...
	        case R.id.delete_city:
	        	if(mAdapter.getCount()>0){
	        		dataBase.removeCity(actionBar.getSelectedNavigationIndex());
